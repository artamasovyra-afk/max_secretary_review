...
- `roles` — список ролей через запятую, например `member,manager`.

Пример:

```text
/tasks/00000000-0000-0000-0000-000000000000?user_id=11111111-1111-1111-1111-111111111111&organization_id=22222222-2222-2222-2222-222222222222&chat_id=33333333-3333-3333-3333-333333333333&roles=manager
```
